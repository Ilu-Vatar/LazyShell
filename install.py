...
try:
    ...
    if whattodo == '1':
        ...
        os.system('apt update && apt install python-pip && pip install terminaltables && apt install git && apt install -f && echo Finished')
        sys.exit()
    elif whattodo == '3':
        sys.exit('Exiting')
    else:
...
def main():
    ...
    if qconn.lower() != 'n':
        os.system('apt update && apt install git && apt install -f')
    print()
